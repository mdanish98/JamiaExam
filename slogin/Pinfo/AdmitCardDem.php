<?php
echo $string = "Danish";
echo "<br/>First character = ";
echo $result = substr($string, 0, 1);
...
<body>
<br/>
    <h3 align='center' style='color:#F00;'><img src="../Images/notallowed.png" height="20" width="20">&nbsp;You Are Not Allowed for Registration.</h3>
    <br/>
    <br/>


<div style="width: 730px; height: 940px; border-style: solid; font-family: Arial;">
<!-- Main Div Starts-->
<table border="1" cellpadding="0" cellspacing="0">
<tr>
<td rowspan="4" colspan="4">
<img src="../Images/JMIAdmitLogo.jpg" />
</td>
<td >
