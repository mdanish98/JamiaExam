...
<div class="">
<div class="headline" style="color:#060">Course Curriculum</div>
...
<table width="960" height="26" cellpadding="2" cellspacing="0" align="center" style="background-color:#3CC; border-radius:5px;">
    <tr>
      ...
      <td width="147"><div class="1tab"><a href="
http://localhost/JamiaExam/Resultsheets/Resultsheets.php"><input name="rs" type="button" value="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Result sheets&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"></a></div>
...
<div class="cascade" id="faculty"></div> 

          <div id="department" class="cascade"></div>
           
          <div id="course" class="cascade"></div>
          
          <div id="courseid" class="cascade"></div>
...
// alert(country_id);	
	...
	if (acad_id.length > 0 ) { 
	 ...
	 $.ajax({
			...
			cache: false,
			beforeSend: function () { 
				$('#faculty').html('<img src="loader.gif" alt="" width="24" height="24">');
			},
